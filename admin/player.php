                ...
                <table class="table table-hover table-striped ">
                    <thead>
                        <tr>
                            ...
                            <td class="text-center"><strong>Medic</strong> <a href="player.php?sort=medlevel&type=ASC<?php if(isset($_GET['letter'])) {echo "&letter=".$_GET['letter'];}?><?php if(isset($_GET['page'])) {echo "&page=".$_GET['page'];}?>" style="color:grey;"><span class="glyphicon glyphicon-sort-by-attributes"></span></a><a href="player.php?sort=medlevel&type=DESC<?php if(isset($_GET['letter'])) {echo "&letter=".$_GET['letter'];}?><?php if(isset($_GET['page'])) {echo "&page=".$_GET['page'];}?>" style="color:grey;"><span class="glyphicon glyphicon-sort-by-attributes-alt"></span></a></td>
